...
#[xee(default_ns(atom = "http://www.w3.org/2005/Atom"))]                 // Default extraction
#[xee(default_ns(nlm = "https://id.nlm.nih.gov/datmm/", "extract1"))]     // "extract1" extraction
struct Entry {
    #[xee(xpath("//id/text()"))]         // Default extract
    #[xee(xpath("//id", "extract1"))]     // "extract1" extract
    id: String,

    #[xee(xpath("//title/text()"))]      // Default extract
    #[xee(xpath("//title", "extract1"))]  // "extract1" extract
    title: String,

    #[xee(xpath("//author/name/text()"))]  // Default extract
    #[xee(xpath("//contrib-group/contrib/name", "extract1"))]  // "extract1" extract
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let entry: Entry = extractor.extract_one(atom_xml)?;
    ...
    let entry: Entry = extractor.extract_one(nlm_xml)?;
